import{r as l,j as e}from"./vendor-react-BwcC2Ydo.js";import{v as be,u as We,b as Ke,N as Ye,S as ue}from"./index-DkC5eqAZ.js";import{D as Ge}from"./DeleteConfirmationModal-eAe5ZocE.js";import{an as He,ar as Ve,g as fe,Y as Xe,W as $e,aO as se,x as De,X as te,as as Qe,at as qe,au as Ze,av as _e,aw as es,ax as ss,b2 as Ne,U as ts,ak as as,ad as ve,aC as ee,ay as je,T as we,R as ls,aA as rs,I as ye,H as ke,aB as is,a7 as Se,br as ns,P as Te,bn as os,a9 as ds,F as cs,a8 as xs,bo as ms}from"./vendor-icons-BIKcqT2E.js";import{u as hs}from"./vendor-router-CpYcqQb6.js";import"./vendor-pdf-Cw62MR9d.js";import"./vendor-other-SQu4theQ.js";import"./vendor-date-qW5d3bni.js";import"./vendor-radix-CLu8eon7.js";import"./vendor-ui-utils-Dr6D9L7d.js";import"./vendor-query-BOUmJV46.js";import"./vendor-cmdk-p92446dP.js";const Pe=l.forwardRef(({jobNote:s,branding:y},E)=>{const x=y?.name||"Eco System",W=y?.logo&&y.logo!==be,m=y?.logo||be,L=y?.phone||"011-2345678",j=y?.email||"info@ecosystem.lk",I=r=>new Date(r).toLocaleDateString("en-GB",{year:"numeric",month:"short",day:"2-digit"}),h=r=>`LKR ${r.toLocaleString("en-LK",{minimumFractionDigits:2})}`,A=r=>({received:"Received",diagnosing:"Diagnosing","waiting-parts":"Waiting for Parts","in-progress":"In Progress",testing:"Testing",completed:"Completed",delivered:"Delivered",cancelled:"Cancelled"})[r]||r,$=r=>({low:"Low",normal:"Normal",high:"High",urgent:"Urgent"})[r]||r,K=r=>({laptop:"Laptop",desktop:"Desktop PC",printer:"Printer",monitor:"Monitor",phone:"Mobile Phone",tablet:"Tablet",other:"Other Device"})[r]||r;return e.jsxs("div",{ref:E,className:"print-job-note",children:[e.jsx("style",{children:`
          /* ═══════════════════════════════════════════════════════════════
